package org.lot.lotfilter.servlet;
 ...
 * Description: 生成验证码的类
 *
 * @Title: VerifiyCodeController
 * @author moinros
 * @date 2019年1月10日
 */

public class VerifiyCodeController extends HttpServlet {
	...
	public void verifiyCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
